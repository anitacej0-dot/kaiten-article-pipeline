...
| Revised draft | `08_revised_draft.md` | не начато | автор | — | |
| Rescore | `09_rescore.md` | не начато | ai-pre-review | — | |
| Publication pack | `10_publication_pack.md` | не начато | package-for-cms | — | только после 90+ |
| Visual brief | `11_visual_brief.md` | не начато | visual-producer | — | |
| 🛑 Visual assets (STOP 5) | `12_visual_assets.md` | не начато | редактор | — | |
